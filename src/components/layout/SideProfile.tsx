...
export default function SideProfile({ isSticky }: Props) {
  return (
    <aside
      ...
      style={{display:'flex', justifyContent:'end', alignItems:'end', paddingRight:'20px'}}
    >
      <div className="bg-white shadow-lg rounded-full dark:bg-[#1D1D1D]" style={{padding:'20px 20px'}}>
        <SocialBtnSide />
      </div>
    </aside>
  );

    ...
    <div className="hidden xl:flex w-full h-[200px] justify-center flex-col items-center mt-[250px]">
      <div className="animate-fadeInTop flex justify-between items-center w-[750px]">
        <div className="flex justify-center items-center">
          ...
          />
          <h1 className="text-[40px] font-bold ml-2 font-fantasy italic" style={{fontFamily:'fantasy', fontStyle:'oblique'}}>
            LIFE IS JOURNEY
          </h1>
        </div>
        <SocialBtn />
      ...
      <div className="flex items-center justify-between w-[750px] mt-[15px]">
        <img
          className="animate-fadeInLeft w-[500px] rounded-[10px]"
        ...
        <div className="w-[230px] h-[340px] flex flex-col justify-between">
          <img
            className="animate-fadeInTop w-full rounded-[10px]"
      ...
      <div className="w-[750px]">
        <h1 className="text-[20px] font-fantasy italic mt-[60px]" style={{fontFamily:'fantasy', fontStyle:'oblique'}}>POST</h1>
      </div>
    </div>
  );
}
